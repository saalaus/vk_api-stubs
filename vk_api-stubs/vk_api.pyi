...
class VkApiMethod(object):
    ...
    class board:
        ...
        def getComments(*, group_id: Positive, topic_id: Positive, need_likes: bool = ...,
                        ...
                        sort: Literal["asc", "desc"] = ...) -> VkObject: ...
        @staticmethod
    ...
    class database:
        ...
        @staticmethod
        def getCitiesById(*, city_ids: str = ...) -> ListOfVkObjects: ...
        @staticmethod
    ...
    class docs:
        ...
        def getMessagesUploadServer(*,
                                    ...
                                    peer_id: int = ...) -> VkObject: ...
        @staticmethod
        def getTypes(*, owner_id: int) -> VkObject: ...
        @staticmethod
        def getUploadServer(*, group_id: Positive = ...) -> VkObject: ...
        @staticmethod
        def getWallUploadServer(*, group_id: Positive = ...) -> VkObject: ...
        @staticmethod
    ...
    class fave:
        ...
        def getPages(*, offset: Positive = ..., count: Positive = ...,
                     ...
                     fields: str = ..., tag_id: int = ...) -> VkObject: ...
        @staticmethod
        def getTags() -> VkObject: ...
        @staticmethod
    ...
    class store:
        ...
        @staticmethod
        def getFavoriteStickers() -> VkObject: ...
        @staticmethod
