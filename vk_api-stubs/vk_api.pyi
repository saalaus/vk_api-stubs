...
class VkApiMethod(object):
    ...
    class downloadedGames:
        @staticmethod
        def getPaidStatus(*, user_id: Positive|None = None) -> dict[str, bool]: ...
    ...
    class gifts:
        @staticmethod
        def get(*, user_id: Positive|None = None, count: Positive|None = None,
                offset: Positive|None = None) -> dict[Any, Any]: ...
    ...
    class podcasts:
        @staticmethod
        def searchPodcast(*, search_string: str, offset: Positive|None = None,
                          count: Positive|None) -> Any: ...
    ...
    class search:
        @staticmethod
        def getHints(*, q: str|None = None, offset: Positive|None = None,
                     limit: Positive|None = None, filters: str|None = None,
                     fields: str|None = None, search_global: bool = False
            ) -> dict[str, Any]: ...
    ...
    class utils:
        ...
        @staticmethod
        def getLastShortenedLinks(*, count: Positive|None=None, offset: Positive|None = None
                                  ) -> dict[Any, Any]: ...
        @staticmethod
        def getLinkStats(*, key: str, source: str|None = None, access_key: str|None = None,
                         interval: Literal["hour", "day", "week", "month", "forever"]| None = None,
                         intervals_count: Positive|None = None, extended: bool = False
                         )->dict[Any, Any]: ...
        @staticmethod
        def getServerTime() -> int: ...
        @staticmethod
        def getShortLink(*, url: str, private: bool = False) -> dict[Any, Any]: ...
        @staticmethod
