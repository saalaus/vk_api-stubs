...
class VkApiMethod(object):
    ...
    class ads:
        @staticmethod
        def getAccounts() -> list[dict[Any, Any]]: ...
        @staticmethod
        def getClients(*, account_id: str = ...) -> list[dict[Any, Any]]: ...
        @staticmethod
        def createClients(*, data: Text, account_id: str = ...) -> list[dict[Any, Any]]: ...
        @staticmethod
        def updateClients(*, data: Text, account_id: str = ...) -> list[dict[Any, Any]]: ...
        @staticmethod
        def deleteClients(*, ids: str, account_id: str = ...) -> list[dict[Any, Any]]: ...
        @staticmethod
        def getCampaigns(*, account_id: str = ..., client_id: int = ...,
                         include_deleted: bool = ..., campaign_ids: str = ...,
                         fields: str = ...) -> list[dict[Any, Any]]: ...
        @staticmethod
        def createCampaigns(*, data: str, account_id: str = ...)->list[dict[Any, Any]]: ...
        @staticmethod
        def updateCampaigns(*, data: str, account_id: str = ...) -> list[dict[Any, Any]]: ...
        @staticmethod
        def deleteCampaigns(*, ids: str, account_id: str = ...)->list[dict[Any, Any]]: ...
        @staticmethod
        def getAds(*, account_id: str = ..., client_id: int = ...,
                   include_deleted: bool = ..., only_deleted: bool = ...,
                   campaign_ids: Text = ..., ad_ids: Text = ...,
                   limit: int = ..., offset: int = ...)->list[dict[Any, Any]]: ...
        @staticmethod
        ...
        def getAdsTargeting(*, account_id: str = ..., client_id: int = ...,
                            ...
                            limit: int = ..., offset: int = ...) -> list[dict[Any, Any]]: ...
        @staticmethod
        def createAds(*, data: Text, account_id: str = ...) -> list[dict[Any, Any]]: ...
        @staticmethod
        def updateAds(*, data: Text, account_id: str = ...) -> list[dict[Any, Any]]:...
        @staticmethod
        def deleteAds(*, ids: str, account_id: str = ...) -> list[dict[Any, Any]]: ...
        @staticmethod
        def checkLink(*, account_id: str = ..., 
                      link_type: Literal["community", "post", "application", "video", "site"],
                      link_url: str = ..., campaign_id: int = ...) -> dict[Any, Any]: ...
        @staticmethod
        def getStatistics(*, account_id: str = ...,
                          ids_type: Literal["ad", "campaign", "client", "office"] = ...,
                          ids: str = ...,
                          period: Literal["day", "week", "month", "year", "overall"] = ...,
                          date_from: str = ..., date_to: str = ..., stats_fields: str = ...) -> list[dict[Any, Any]]: ...
        @staticmethod
        def getDemographics(*, account_id: str = ...,
                            ids_type: Literal["ad", "campaign"] = ...,
                            ids: str = ...,
                            period: Literal["day", "month", "overall"] = ...,
                            date_from: str = ..., date_to: str = ...) -> list[dict[Any, Any]]: ...
        @staticmethod
        def getPostsReach(*, account_id: str = ...,
                          ids_type: Literal["ad", "campaign"] = ...,
                          ids: str = ...) -> list[dict[Any, Any]]: ...
        @staticmethod
        def getBudget(*, account_id: str = ...)->int: ...
        @staticmethod
        def getOfficeUsers(*, account_id: str = ...) -> list[dict[Any, Any]]: ...
        @staticmethod
        def addOfficeUsers(*, data: Text, account_id: str = ...)->list[dict[Any, Any]]: ...
        @staticmethod
        def updateOfficeUsers(*, data: Text, account_id: str = ...) -> list[dict[Any, Any]]: ...
        @staticmethod
        def removeOfficeUsers(*, ids: str, account_id: str = ...) -> list[dict[Any, Any]]: ...
        @staticmethod
        def getTargetingStats(*, link_url: str, account_id: int = ..., client_id: int = ...,
                              ...
                              impressions_limit_period: int = ...) -> dict[Any, Any]: ...
        @staticmethod
        def getSuggestions(*, section: str, ids: str = ..., q: str = ...,
                           country: int = ..., cities: str = ...,
                           lang: Literal["ru", "ua", "en"] = ...) -> list[dict[Any, Any]]: ...
        @staticmethod
        def getCategories(*, lang: str = ...) -> dict[Any, list[dict[Any, Any]]]: ...
        @staticmethod
        def getUploadURL(*, ad_format: int = ..., icon: int = ...) -> str: ...
        @staticmethod
        def getVideoUploadURL() -> str: ...
        @staticmethod
        def getFloodStats(*, account_id: str = ...) -> dict[Any, Any]: ...
        @staticmethod
        def getRejectionReason(*, account_id: str = ..., ad_id: str = ...) -> dict[Any, Any]: ...
        @staticmethod
        ...
        def getTargetGroups(*, account_id: str = ..., client_id: int = ...,
                            extended: bool = ...) -> list[dict[Any, Any]]: ...
        @staticmethod
        ...
        def createTargetPixel(*, category_id: str, account_id: str = ...,
                              ...
                              domain: str = ...) -> dict[Any, Any]: ...
        @staticmethod
        def updateTargetPixel(*, category_id: str, account_id: str = ...,
                              client_id: int = ..., target_pixel_id: str,
                              name: str = ..., domain: str = ...) -> dict[Any, Any]: ...
        @staticmethod
        def deleteTargetPixel(*, account_id: str = ..., client_id: int = ...,
                              target_pixel_id: str) -> Literal[1]: ...
        @staticmethod
        def getTargetPixels(*, account_id: str = ..., client_id: int = ...)->list[dict[Any, Any]]: ...
        @staticmethod
        def getLookalikeRequests(*, account_id: str = ..., client_id: int = ...,
                                 requests_ids: str = ..., offset: int = ...,
                                 limit: int = ...,
                                 sort_by: Literal["id", "update_time"] = ...) -> dict[Any, Any]: ...
        @staticmethod
        def getMusicians(*, artist_name: str = ...) -> list[dict[Any, Any]]: ...
        @staticmethod
        def getMusiciansByIds(*, ids: str) -> list[dict[Any, Any]]: ...
        @staticmethod
